...
public class UserReviewPK implements Serializable {
    ...
    public UserReviewPK(String userUsername, String booksIsbn) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UserReviewPK)) {
            return false;
        }
        UserReviewPK other = (UserReviewPK) object;
    ...
    public String toString() {
        return "entity.UserReviewPK[ userUsername=" + userUsername + ", booksIsbn=" + booksIsbn + " ]";
    }
