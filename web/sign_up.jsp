    ...
    <body>
        ...
        <form method="GET" id="regForm" action="user_signup">
            ...
            <div class="tab">Login Info:
                <p><input type="text" id="user_name" name="user_name" placeholder="Username..." oninput="this.className = ''" autocomplete="new-username"></p>
            ...
            <div class="tab">Password:
              ...
              <p><input type="password" id="repeat_pass" name="repeat_pass" placeholder="Repeat Password..." oninput="this.className = ''" ></p>
            </div>
            <div class="tab">Personal Info:
                <p><input type="date" id="birth-date" name="birth-date" oninput="this.className = ''" ></p>
                <p><select id="country" name="country" placeholder="Select Country..." oninput="this.className = ''">
                    <option value="Select" selected disabled hidden>Select Country...</option>
                 ...
                 <select class="gen" name="gender" id="gender" required>
                    <option value="gender" selected disabled hidden>Select Gender...</option>
            ...
            <p style="text-align: center">Already a member? <a href="login.jsp" style="color: white">Log in</a></p>
