...
<html>
    ...
    <body>
        ...
        <div class="page_body">
              <%
                String param = request.getParameter("WhichBooks");
                if(param != null && !param.equals("")){
                  ...
                  if(param.equals("1") || param.equals("4")){
                    userbooklist = userbookdao.getWantToReadList(session.getAttribute("username").toString());
                  ...
                  if(param.equals("4")){
                      ...
                      finished = userbookdao.getFinishedList(session.getAttribute("username").toString());
                      reading = userbookdao.getReadNowList(session.getAttribute("username").toString());
                      want = userbookdao.getWantToReadList(session.getAttribute("username").toString());
                  ...
                  out.print("<a class=\"active\" href=\"?WhichBooks=4"+"\">All Books</a><hr>");
                  out.print("<a class=\"active\" href=\"?WhichBooks=1"+"\">Want To Read (TBR)</a><hr>");
                  out.print("<a class=\"active\" href=\"?WhichBooks=2"+"\">Reading Now</a><hr>");
                  out.print("<a class=\"active\" href=\"?WhichBooks=3"+"\">Finished</a>");
                  out.print("</div>");
                }
              %>
        </div>
