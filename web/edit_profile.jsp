        ...
        <div class="page_body">
            <div class="body_left">
                <form method="GET" action="user_edit">
                    <label>First Name: &emsp; &emsp; &emsp;
                        <input type="text" value=<%= firstname%> id="first_name" name="first_name" required></label><br>
                    <label>Last Name: &emsp; &emsp; &emsp;
                        <input type="text" value=<%= lastname%> id="last_name" name="last_name" placeholder="Enter your last name"></label><br>
                    <label>User Name:  &emsp; &emsp; &emsp;
                        <input type="text" value=<%= user_name%> id="user_name" name="user_name" disabled></label><br>
                    <label>Email:  &emsp; &emsp; &emsp; &emsp; &emsp;
                        <input type="text" value=<%= email%> id="email" name="email" placeholder="Enter your email"></label><br>
                    <label>New Password: &emsp; &ensp;
                        <input type="password" id="password" name="password" placeholder="Enter your new password" autocomplete="new-password"></label><br>
                    <label>Birthday: &emsp; &emsp; &emsp; &emsp;
                        <input type="date" value=<%= birthday%> id="birth-date" name="birth-date"></label><br>
                    <label>Country: &emsp; &emsp; &emsp; &emsp;
                    ...
                    <label>Gender:  &emsp; &emsp; &emsp; &emsp; &nbsp;     
                    ...
                    <label>Current Password* &nbsp;
                        <input type="password" id="repeat_pass" name="repeat_pass" placeholder="Enter your old password" required></label>
                    <%
                        String error = request.getParameter("error");
                        if(error!=null){
                            out.print("<center style=\"color:red;\">"+request.getParameter("error")+"</center>");
                        }
                    %>
                    <br>
                    <button>Save</button>
            ...
            <div class="body_right">
                <form method="post" action="upload_image" enctype="multipart/form-data">
                    <img src=<%= profileImage%> alt="Profile_picture" style="height: 200px" class="prof_pic">
