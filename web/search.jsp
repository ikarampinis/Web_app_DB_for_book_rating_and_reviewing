    ...
    <body onload="searchFunction()">
        ...
        <script>
            function searchFunction(){
                ...
                $.ajax({
                   url: bookUrl + "intitle:"+searchData +"&maxResults=40&"+apiKey,
                   dataType: "json",
                ...
                function next(k){
                    if(k<total_response_size){
                        $.ajax({
                            url: bookUrl + "intitle:"+searchData +"&maxResults=40&"+"startIndex="+k+"&"+apiKey,
                            dataType: "json",
                            success: function(response) {
                              console.log(response);
                              if (response.totalItems === 0) {
                ...
                function formatOutput(info) {
                  ...
                  var htmlCard = `<div class="book">
                        <div class="book_photo">
                          <img src="\${info.bookImg}" style="width: 170px; height: 250px">
                        </div>
                        <div class="book_info">
                          <h3>\${info.title}</h3>
